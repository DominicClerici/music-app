...
| T8 | USER listening gate (§14.10 checklist + formal §8.4 pass → listening/log.jsonl) — instructions handed to user after be3c246; corpus capture (T9) blocked until this passes (§8.1 bootstrap order) | user | **awaiting user** | — |
