...
| T7 | Calibrate → first blessed `styles/blues/calibration.yaml` (487 lines; 8 moods; artifact check in progress) + S21-6/C-25 + C-24-wording amendments ride this commit | orchestrator+opus | in progress | — |
